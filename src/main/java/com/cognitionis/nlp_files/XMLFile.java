...
import com.cognitionis.xml_parsers.SimpleErrorHandler;
import com.cognitionis.xml_parsers.Xml2PlainHandler;
import java.io.*;
...
//                }
                File xsd_file = new File(FileUtils.getApplicationPath() + FileUtils.NLPFiles_descr_path + extension + ".xsd");
